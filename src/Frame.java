...
public class Frame extends JFrame implements KeyEventDispatcher {
    ...
    public void paint(Graphics g) {
        ...
        if (p != null) {
            ...
            if (!gender) {
                ...
                g2d.setColor(new Color(255, 230, 189));
            }
            g2d.fillRect(0, 0, getWidth(), getHeight());
            p.draw(g2d, 0, 0, 700, otstup, "up", 0, true);
            int z = (getHeight() - 30 * (roads.size() + rivers.size() + forests.size()) - otstup);
            p.draw(g2d, 0, 1000 - z, 700, z, "down", 0, true);
    ...
    public void drawCar(Graphics2D g2d, Car c, double speed1){
        ...
        //g2d.drawRect((int)c.x,(int)c.y,c.w,c.h);
        if (speed1>0) {
            boolean t = true;
    ...
    public void drawRoad(Graphics2D g2d, Road r){
        p.draw(g2d, 0,r.y, getWidth(), 30,"road", 0,false);
